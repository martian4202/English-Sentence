The type set of a constraint is then constructed out of the type sets of its elements. This may seem like a <digression> from the topic of using operators with parameterized types, but we'll get there in the end.
